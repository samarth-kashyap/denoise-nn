...
interval_size = (x.max() - x.min())/(num_lorentzians+1)
xlo = [interval_size/2*(1+i) for i in range(num_lorentzians)]
xhi = [interval_size/2*(2+i) for i in range(num_lorentzians)]
